...
* :seedling: **Mushroom stumps can have a chance to regrow each day**. When enabled, it is half the normal growth chance. It will not occur when normal growth would not occur (ie. hibernation).
